...
class MoveGripperConfirmation {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MoveGripperConfirmation(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new MoveGripperConfirmation(null);
...
module.exports = MoveGripperConfirmation;
