...
(cl:defmethod command_id-val ((m <MoveGripperCommand>))
...
(cl:defmethod command-val ((m <MoveGripperCommand>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:command-val is deprecated.  Use custom_messages-msg:command instead.")
  (command m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<MoveGripperCommand>)))
  ...
  "01641dfa5597b5e4124d01564db602c3")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'MoveGripperCommand)))
  "Returns md5sum for a message object of type 'MoveGripperCommand"
  "01641dfa5597b5e4124d01564db602c3")
