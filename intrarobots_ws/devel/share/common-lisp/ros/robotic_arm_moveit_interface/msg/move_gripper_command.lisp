...
(cl:defclass <move_gripper_command> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass move_gripper_command (<move_gripper_command>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <move_gripper_command>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'move_gripper_command)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robotic_arm_moveit_interface-msg:<move_gripper_command> is deprecated: use robotic_arm_moveit_interface-msg:move_gripper_command instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <move_gripper_command>))
...
(cl:defmethod robot_name-val ((m <move_gripper_command>))
...
(cl:defmethod cmd-val ((m <move_gripper_command>))
  ...
  (cmd m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <move_gripper_command>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <move_gripper_command>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<move_gripper_command>)))
  "Returns string type for a message object of type '<move_gripper_command>"
  "robotic_arm_moveit_interface/move_gripper_command")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'move_gripper_command)))
  "Returns string type for a message object of type 'move_gripper_command"
  "robotic_arm_moveit_interface/move_gripper_command")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<move_gripper_command>)))
  "Returns md5sum for a message object of type '<move_gripper_command>"
  "c7eca5acbbe328698e1bba54b90270b6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'move_gripper_command)))
  "Returns md5sum for a message object of type 'move_gripper_command"
  "c7eca5acbbe328698e1bba54b90270b6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<move_gripper_command>)))
  "Returns full string definition for message of type '<move_gripper_command>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'move_gripper_command)))
  "Returns full string definition for message of type 'move_gripper_command"
  (cl:format cl:nil "Header header~%string robot_name~%string cmd~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <move_gripper_command>))
  (cl:+ 0
     (roslisp-msg-protocol:serialization-length (cl:slot-value msg 'header))
     4 (cl:length (cl:slot-value msg 'robot_name))
     4 (cl:length (cl:slot-value msg 'cmd))
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <move_gripper_command>))
  "Converts a ROS message object to a list"
  (cl:list 'move_gripper_command
