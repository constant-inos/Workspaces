...
def main():
    ...
    sub = rospy.Subscriber("/panda/camera_link_optical/image_raw", Image, read_camera) # Camera sensor, Image is the data type sensor_msgs/Image
    sub2 = rospy.Subscriber("/panda/move_group/result", MoveGroupActionResult, execution_status)
    rospy.spin()
